...
const SideMenuTest = ({page}: {page: number}) => {
  ...
  return (
    ...
    ref={sidebarRef}
    className={cn(
      "group/sidebar h-full bg-grayscale-40 border-grayscale-40 overflow-y-auto fixed flex w-60 flex-col z-[99999] cursor-ew-resize",
