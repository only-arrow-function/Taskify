...
const SideMenuAddDashBoards = ({ handleOpenModal }: { handleOpenModal: () => void }) => {
  ...
  return (
    <div className="w-full flex items-center my-[15px] justify-center sm:justify-between sm:mb-[15px]">
      <h3 className="hidden sm:block text-[12px] font-bold text-grayscale-60">Dash Boards</h3>
