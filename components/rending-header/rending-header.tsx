...
const RendingHeader = (props: RendingHeaderProps) => {
  const darkmodeClassName = props.isDarkmode
    ? 'bg-black text-white'
    : 'bg-white text-black';
  ...
  return (
    <header className="w-full">
      <div
        className={`p-4 pr-20 flex justify-between items-center max-xl:pr-10 max-sm:p-6 max-sm:py-4 ${darkmodeClassName}`}
      >
